        ...
        return (
          <GlassCard className="content-card">
            ...
            <div className="empty-state">
              ...
              <p className="empty-title">Relatorios do Sistema</p>
              <p className="empty-subtitle">Os relatorios estarao disponiveis em breve</p>
            </div>
          </GlassCard>
        );
      case 'configuracoes':
        return (
          <GlassCard className="content-card">
            ...
            <div className="empty-state">
              ...
              <p className="empty-title">Configuracoes do Sistema</p>
              <p className="empty-subtitle">As configuracoes estarao disponiveis em breve</p>
            </div>
          </GlassCard>
        );
      default:
